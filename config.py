...
LANG = {
    ...
    "${activation_duration}block.minecraft.acacia_button": "{lang.value} {glyph.clock}≥15t",
    "${activation_duration}block.minecraft.bamboo_button": "{lang.value} {glyph.clock}≥15t",
    "${activation_duration}block.minecraft.birch_button": "{lang.value} {glyph.clock}≥15t",
    "${activation_duration}block.minecraft.cherry_button": "{lang.value} {glyph.clock}≥15t",
    "${activation_duration}block.minecraft.crimson_button": "{lang.value} {glyph.clock}≥15t",
    "${activation_duration}block.minecraft.dark_oak_button": "{lang.value} {glyph.clock}≥15t",
    "${activation_duration}block.minecraft.jungle_button": "{lang.value} {glyph.clock}≥15t",
    "${activation_duration}block.minecraft.mangrove_button": "{lang.value} {glyph.clock}≥15t",
    "${activation_duration}block.minecraft.oak_button": "{lang.value} {glyph.clock}≥15t",
    "${activation_duration}block.minecraft.pale_oak_button": "{lang.value} {glyph.clock}≥15t",
    "${activation_duration}block.minecraft.polished_blackstone_button": "{lang.value} {glyph.clock}10t",
    "${activation_duration}block.minecraft.spruce_button": "{lang.value} {glyph.clock}≥15t",
    "${activation_duration}block.minecraft.stone_button": "{lang.value} {glyph.clock}10t",
    "${activation_duration}block.minecraft.warped_button": "{lang.value} {glyph.clock}≥15t",
    # Pressure Plates (signal duration)
    "${activation_duration}block.minecraft.acacia_pressure_plate": "{lang.value} {glyph.clock}≥10t",
    "${activation_duration}block.minecraft.bamboo_pressure_plate": "{lang.value} {glyph.clock}≥10t",
    "${activation_duration}block.minecraft.birch_pressure_plate": "{lang.value} {glyph.clock}≥10t",
    "${activation_duration}block.minecraft.cherry_pressure_plate": "{lang.value} {glyph.clock}≥10t",
    "${activation_duration}block.minecraft.crimson_pressure_plate": "{lang.value} {glyph.clock}≥10t",
    "${activation_duration}block.minecraft.dark_oak_pressure_plate": "{lang.value} {glyph.clock}≥10t",
    "${activation_duration}block.minecraft.heavy_weighted_pressure_plate": "{lang.value} {glyph.clock}≥5t",
    "${activation_duration}block.minecraft.jungle_pressure_plate": "{lang.value} {glyph.clock}≥10t",
    "${activation_duration}block.minecraft.light_weighted_pressure_plate": "{lang.value} {glyph.clock}≥5t",
    "${activation_duration}block.minecraft.mangrove_pressure_plate": "{lang.value} {glyph.clock}≥10t",
    "${activation_duration}block.minecraft.oak_pressure_plate": "{lang.value} {glyph.clock}≥10t",
    "${activation_duration}block.minecraft.pale_oak_pressure_plate": "{lang.value} {glyph.clock}≥10t",
    "${activation_duration}block.minecraft.polished_blackstone_pressure_plate": "{lang.value} {glyph.clock}≥10t",
    "${activation_duration}block.minecraft.spruce_pressure_plate": "{lang.value} {glyph.clock}≥10t",
    "${activation_duration}block.minecraft.stone_pressure_plate": "{lang.value} {glyph.clock}≥10t",
    "${activation_duration}block.minecraft.warped_pressure_plate": "{lang.value} {glyph.clock}≥10t",
    # Other Redstone Components (signal duration)
    "${activation_duration}block.minecraft.detector_rail": "{lang.value} {glyph.clock}≥10t",
    "${activation_duration}block.minecraft.lectern": "{lang.value} {glyph.clock}1t",
    "${activation_duration}block.minecraft.lightning_rod": "{lang.value} {glyph.clock}4t",
    "${activation_duration}block.minecraft.redstone_lamp": "{lang.value} {glyph.clock}≥2t",
    "${activation_duration}block.minecraft.target": "{lang.value} {glyph.clock}4/10t",
    "${activation_duration}block.minecraft.tripwire_hook": "{lang.value} {glyph.clock}≥5t",
    # Other Redstone Components (signal delay)
    "${activation_duration}block.minecraft.comparator": "{lang.value} {glyph.delay}1t {glyph.clock}1t",
    "${activation_duration}block.minecraft.crafter": "{lang.value} {glyph.delay}2t",
    "${activation_duration}block.minecraft.daylight_detector": "{lang.value} {glyph.delay}10t",
    "${activation_duration}block.minecraft.dispenser": "{lang.value} {glyph.delay}2t",
    "${activation_duration}block.minecraft.dropper": "{lang.value} {glyph.delay}2t",
    "${activation_duration}block.minecraft.hopper": "{lang.value} {glyph.delay}4t",
    "${activation_duration}block.minecraft.observer": "{lang.value} {glyph.delay}1t {glyph.clock}1t",
    "${activation_duration}block.minecraft.piston": "{lang.value} {glyph.delay}0/0.5t {glyph.clock}1t",
    "${activation_duration}block.minecraft.redstone_torch": "{lang.value} {glyph.delay}1t",
    "${activation_duration}block.minecraft.repeater": "{lang.value} {glyph.delay}1/2/3/4t {glyph.clock}1/2/3/4t",
    "${activation_duration}block.minecraft.sticky_piston": "{lang.value} {glyph.delay}0/0.5t {glyph.clock}1t",
    # Other Redstone Components (signal duration & comparator chart)
    "${sculk_both}block.minecraft.calibrated_sculk_sensor": "{lang.value} {glyph.clock}5t {glyph.delay}5t{align.left}{format.white}{glyph.sculk_sensor_guide}",
    "+${sculk_chart}block.minecraft.calibrated_sculk_sensor": "{lang.value}{align.left}{format.white}{glyph.sculk_sensor_guide}",
    "+${sculk_duration}block.minecraft.calibrated_sculk_sensor": "{lang.value} {glyph.clock}5t {glyph.delay}5t",
    ...
    "${sculk_both}block.minecraft.sculk_sensor": "{lang.value} {glyph.clock}15t {glyph.delay}5t{align.left}{format.white}{glyph.sculk_sensor_guide}",
    "+${sculk_chart}block.minecraft.sculk_sensor": "{lang.value}{align.left}{format.white}{glyph.sculk_sensor_guide}",
    "+${sculk_duration}block.minecraft.sculk_sensor": "{lang.value} {glyph.clock}15t {glyph.delay}5t",
    ...
    "${ss_crafter}container.crafter": "{lang.value}{align.after}{format.white}{glyph.crafter_guide}",
...
KEY_VALUE_DEFAULTS_AND_FILTER = {
    ...
    "lang_rpo/*.json": {
        ...
        "rpo.redstonetweaks.tooltips.ss_crafter": "  ⤷ Crafter",
    ...
    "lang_rpo/*.json.rpo": {
        "expansions": {
            ...
            "ss_crafter": "(tooltips.ss_override.all | (tooltips.ss_override.select & tooltips.ss_crafter)) ? '' : '#'",
